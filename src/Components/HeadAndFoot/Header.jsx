            ...
            <div className ="title-bar">
                <div className="row">
                        ...
                        <div className = "col-3 log-reg">
                            {props.loggedIn ? <Redirect to="/" />: <span><Link to="/login">Login</Link></span>}  {props.loggedIn ? null: <span> <Link to ='/register'>Register</Link></span>} <span> <Link to = '/'>Home</Link> </span> {props.loggedIn ? <span><Link to="/" className = "header-link" onClick={props.logout}>Logout</Link></span>: null}
                        </div>
                </div>        
            </div>
