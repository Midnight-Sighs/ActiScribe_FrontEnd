...
export const CalendarCreators = () =>{
    return(
        <>
            <p className="bold-text">This site isn't meant to be a pretty calendar.  There are plenty of references for creating nice calendars in addition to many ways of creating them from scratch.</p>
            <ul>
