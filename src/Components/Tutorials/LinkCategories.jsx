...
export const ActivityIdeas = () =>{
    return(
        <>
            <p id="ActivityIdeas" className="bold-text">Sometimes we're just starting out or we get stuck in a rut.  The provided links are here to help prevent that rut and give you ideas for types of activities.</p>
            <div>
                <ul>
...
export const Regulations = () =>{
    return(
        <>
            <p id="Regulations" className="bold-text">Following are links where you can find rules and regulations in regards to nursing facilities.</p>
            <ul>
...
export const CalendarCreators = () =>{
    return(
        <>
            <p id="CalendarCreators" className="bold-text">This site isn't meant to be a pretty calendar.  There are plenty of references for creating nice calendars in addition to many ways of creating them from scratch.</p>
            <ul>
...
export const CraftIdeas = () =>{
    return(
        <>
            <p id="CraftIdeas" className="bold-text">Crafts are insanely expansive.  There are so many different routes and ways to go.  What I post are only the tip of the iceberg as far as resources go.</p>
            <ul>
