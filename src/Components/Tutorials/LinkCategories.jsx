...
export const ActivityIdeas = () =>{
    return(
        <>
            ...
            <div>
                <ul>
                    <li><a className="tut" href="https://www.notjustbingo.com/" target="_blank" rel="noopener noreferrer">Not Just Bingo</a></li>
                    <li><a href="https://www.greatseniorliving.com/articles/fun-activities-for-seniors">Great Senior Living</a></li>
                    <li><a href="https://www.vivehealth.com/blogs/resources/activities-elderly-seniors">110 Things for Seniors To Do</a></li>
    ...
    return(
        <>
            ...
            <ul>
                ...
                <li><a href="https://www.cms.gov/Regulations-and-Guidance/Guidance/Manuals/Internet-Only-Manuals-IOMs-Items/CMS1201984">State Operations Manual</a></li>
                <li><a href="https://www.cdc.gov/phlp/publications/topic/hipaa.html#:~:text=The%20Health%20Insurance%20Portability%20and,the%20patient's%20consent%20or%20knowledge.">HIPAA Laws</a></li>
            </ul>
        </>
    )
}
...
export const CalendarCreators = () =>{
    return(
        <>
            ...
            <ul>
                <li><a href="https://www.activityconnection.com/account/monthly/8/2018/calendars/">Activity Connection</a></li>
                <li><a href="https://www.goldencarers.com/free-activity-calendar-for-seniors/4857/">Golden Carers</a></li>
    ...
    return(
        <>
            ...
            <ul>
                ...
                <li><a href="https://diyjoy.com/easy-crafts-to-make-and-sell/">Random Crafts in various degrees of simplicity</a></li>
                <li><a href="https://www.countryliving.com/diy-crafts/">Country Living</a></li>
